...
export default function SelectCourseTeachersCard({selecCurso, setCourseId}) {
    ...
    return(
        <div className="w-full bg-[#F8F7FC] rounded-lg border px-2.5 gap-2 flex flex-col py-4">
            ...
            <div className="w-full flex flex-row items-center">
                ...
                <div className="grid grid-row-2 gap-1" >
                    <Button onClick={() => setCourseId(id, "addAll", cursoData.horarios.map(horario => horario.horarioId))} className="" variant="outline">
                        <Star />
                        <p className="text-xs">Seleccionar todos</p>
                    </Button>
                    <Button onClick={() => setCourseId(id, "removeAll")} variant="outline">
                        <StarOff />
